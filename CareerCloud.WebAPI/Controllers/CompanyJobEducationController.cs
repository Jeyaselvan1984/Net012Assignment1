...
namespace CareerCloud.WebAPI.Controllers
{
    ...
    public class CompanyJobEducationController : ControllerBase
    {
        ...
        {
            var copmanyJobEducations = _logic.GetAll();
            if (copmanyJobEducations == null)
            {
                return NotFound();
            }
            else
            {
                return Ok(copmanyJobEducations);
            }
        }
        ...
        public ActionResult PostCompanyJobEducation(
            [FromBody]CompanyJobEducationPoco[] compJobEducationPocos)
        {
            _logic.Add(compJobEducationPocos);
            return Ok();
        }
